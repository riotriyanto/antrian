          ...
          <div class="row">     
            <div class="span12"><br>
              <div class="row">
                ...
                <div class="widget ">
                  <font style="font-size: 30px;">Hai <b><?php echo $this->session->userdata('nama') ?></b></font><a href="<?php echo base_url() ?>logout"><button id="keluar" class="btn btn-danger" style="float: right;margin-top: 6px;"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Keluar</button></a><br><br>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#kirim').on('click', function(){
      ...
      if (pesan == "") {pesan="Tidak ada catatan";}
      // alert(pesan);
      $.ajax({
        url : "<?=$api ?>operator/pemberitahuan.php",
        type : "POST",
        dataType : "JSON",
