...
class Admin extends CI_Controller {
	...
	public function maksimakapi_Antrian($value='')
	{
		$data['title'] = 'Maksimal api_Antrian';
		$data['api'] = $this->api();
		$this->load->view('admin/header', $data);
		$this->load->view('admin/menu');
		$this->load->view('admin/close_menu');
		$this->load->view('admin/view/api_antrian/maksimal');
		$this->load->view('admin/footer');
	}
	...
	public function maksimalJarak($value='')
	{
		...
		$this->load->view('admin/menu');
		$this->load->view('admin/close_menu');
		$this->load->view('admin/view/api_antrian/jarak');
		$this->load->view('admin/footer');
	}
