...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Nama Singkat Aplikasi</b></span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Aplikasi</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li><a href="https://adminlte.io/docs"><i class="fa fa-dashboard"></i> <span>Documentation</span></a></li>
        ...
        <li><a href="<?php echo base_url() ?>logout"><i class="fa fa-user"></i> <span>My Account<t/span></a></li> 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">RTO Developer</a>.</strong> All rights
    reserved.
  </footer>
