  ...
  $(document).ready(function(){
      ...
      $('#next').on('click', function(){
        ...
        if (id_loket==""){
          ...
          $.ajax({
            type : 'POST',
            url :"<?=$api ?>cs/cs_panggil_antrian_terlewati.php",
            dataType : 'JSON',
      ...
      $('#hangus').on('click', function(){
        ...
        $.ajax({
          ...
          dataType : "JSON",
          data : {ket:ket, id_layanan:id_layanan, nik:nik, id_user_cs:id_user_cs, id_loket:id_loket, no_antrian:no_antrian, id_nomor:id_nomor},
          success : function(data){
            console.log(data);
            if (data.success == 1) {
                alert(data.pesan);
