...
session_set_cookie_params(36000);
    session_start();
    if (!empty($_SESSION['id_loket'])) {
        echo "<script>alert('Untuk memilih Loket lagi, anda harus logout terlebih dahulu');location='layanan.php'</script>";
    }
 ?>
 <!-- Image and text -->
