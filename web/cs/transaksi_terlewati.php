          ...
          <div class="row">     
            <div class="span12"><br>
              <div class="row">
                ...
                <div class="widget ">
                  <font style="font-size: 30px;">Hai <b><?php session_start(); echo $_SESSION['nama'] ?></b>, anda berada di Loket <b><?php echo $_SESSION['nomor_loket']; ?></b></font><a href="logout.php"><button id="keluar" class="btn btn-danger" style="float: right;margin-top: 6px;"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Keluar</button></a><br><br>
  ...
  $(document).ready(function(){
      ...
      $('#next').on('click', function(){
        ...
        var id_loket = "<?php echo $_SESSION['id_loket'] ?>";
          $.ajax({
            type : 'POST',
            url :"<?php echo $url ?>cs/cs_panggil_antrian_terlewati.php",
            dataType : 'JSON',
