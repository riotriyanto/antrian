...
<body style="font-size: 14px;">
  ...
  ?>
	<div class="container"><br>
		<div class="row">
			<div class="col-md-12">
				<font style="font-size: 25px">Selamat datang, <?php  echo $_SESSION['nama']; ?> Anda berada di loket <?php echo $_SESSION['nomor_loket'] ?></font> <a href="logout.php"><button class="btn btn-danger" style="float: right;margin-top: 6px;"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Keluar</button></a>
			</div>
		</div><br>
		<div class="row">
			<div class="col-md-12">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			// 	$.ajax({
			// 		type : "POST",
			// 		url : "<?php echo $url ?>cs/login_loket.php",
			// 		dataType : "JSON",
								    		...
								    		"<div class='panel panel-default'>"+
											  	...
											  	"<div class='panel-body' style='height:130px'>"+
											  		...
											  		"<form action='transaksi.php' method='POST'>"+
											  			...
											  			"<input type='hidden' name='id_loket' value='<?php echo $_SESSION['id_loket'] ?>'>"+
											  			"<input type='hidden' name='nomor_loket' value='<?php echo $_SESSION['nomor_loket'] ?>'>"+
		    ...
		    function show1(){
		      ...
		      $.ajax({
		        type   : 'POST',
		        url    : "<?php echo $url ?>cs/get_layanan_terlewati.php",
		        dataType : "JSON",
		        data : {test:test},
		        success : function(data){
		        	// console.log(data);
								    		...
								    		"<div class='panel panel-default'>"+
											  	...
											  	"<div class='panel-body' style='height:130px'>"+
											  		...
											  		"<div class='progress'>"+
											  			...
											  			"</div>"+
											  		"</div>"+
											  		"<form action='transaksi_terlewati.php' method='POST'>"+
											  			"<input type='hidden' name='id_layanan' value='"+data[i].id_layanan+"'>"+
											  			"<input type='hidden' name='jenis_layanan' value='"+data[i].jenis_layanan+"'>"+
											  			"<input type='hidden' name='id_loket' value='<?php echo $_SESSION['id_loket'] ?>'>"+
											  			"<input type='hidden' name='nomor_loket' value='<?php echo $_SESSION['nomor_loket'] ?>'>"+
