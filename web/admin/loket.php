                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nomor loket</label>
                            <div class="col-md-10">
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		...
    		function show(){
    			$.ajax({
    				type : "POST",
    				url : "<?php echo $url ?>admin/loket_read.php",
    				dataType : "JSON",
    				data : {},
                    ...
                    for(i=0; i<data.length; i++){
                        ...
                        html += '<tr>'+
                                ...
                                '<td style="text-align:right;">'+
                                    ...
                                    '<a href="javascript:void(0);" class="btn btn-danger btn-sm item_delete" data="'+data[i].id_loket+'" data2="'+data[i].nomor_loket+'">Hapus</a>'+' '+
                                '</td>'+
                                '</tr>';
                                n++;
            ...
            $('#btn_save').on('click',function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/loket_create.php",
                    type : "POST",
                    dataType : "JSON",
             ...
             $('#show_data').on('click','.item_reset',function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/loket_read_by_id.php",
                    type : "POST",
                    dataType : "JSON",
             ...
             $('#btn_reset').on('click',function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/loket_reset_id.php",
                    type : "POST",
                    dataType : "JSON",
                    data : {id_loket: id_loket},
                    success : function(data){
            ...
            $('#btn-update').on('click', function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/loket_update.php",
                    type : "POST",
                    dataType : "JSON",
            ...
            $('#show_data').on('click','.item_delete',function(){
             ...
             $('#btn_hapus').on('click',function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/loket_delete.php",
                    type : "POST",
                    dataType : "JSON",
                    data : {id_loket: id_loket},
                    success : function(data){
