...
<div class="row">
        <div class="col-12">
            <div class="col-md-12">
                ...
                <h1>Manajemen
                    <small>Notifikasi Android</small>
                </h1>
            </div>
            <table class="table table-striped" id="mydata">
                <thead>
                    <tr>
                        <th width="">Notifikasi</th>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Notifikasi Android</label>
                            <div class="col-md-10">
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		...
    		function show(){
    			$.ajax({
    				type : "POST",
    				url : "<?php echo $url ?>admin/notif_read.php",
    				dataType : "JSON",
    				data : {},
            ...
            $('#btn-update').on('click', function(){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        if (data.status) {
                            $('#alert-success').show();
                            $('#alert-success').html("Berhasil mengubah Notifikasi Android");
                        }else{
                            $('#alert-danger').show();
                            $('#alert-danger').html("Gagal mengubah Notifikasi Android");
                        }
                        show();
