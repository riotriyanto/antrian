    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            function show(){
                $.ajax({
                    type : "POST",
                    url : "<?php echo $url ?>admin/tgl_read.php",
                    dataType : "JSON",
                    data : {},
            ...
            $('#btn_save').on('click',function(){
                var tgl = $('#i_tgl').val();
                $.ajax({
                    url : "<?php echo $url ?>admin/tgl_create.php",
                    type : "POST",
                    dataType : "JSON",
                    data : {tgl:tgl},
                    success : function(data){
            ...
            $('#show_data').on('click','.item_edit',function(){
                ...
                // alert(id_tgl);
                $.ajax({
                    url : "<?php echo $url ?>admin/tgl_read_by_id.php",
                    type : "POST",
                    dataType : "JSON",
                    data : {id_tgl: id_tgl},
                    success : function(data){
            ...
            $('#btn-update').on('click', function(){
                ...
                var tgl = $('#u_tgl').val();
                $.ajax({
                    url : "<?php echo $url ?>admin/tgl_update.php",
                    type : "POST",
                    dataType : "JSON",
            ...
            $('#show_data').on('click','.item_delete',function(){
             ...
             $('#btn_hapus').on('click',function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/tgl_delete.php",
                    type : "POST",
                    dataType : "JSON",
                    data : {id_tgl: id_tgl},
                    success : function(data){
