    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		...
    		function show(){
    			$.ajax({
    				type : "POST",
    				url : "<?php echo $url ?>admin/user_read.php",
    				dataType : "JSON",
    				data : {},
    		 ...
    		 $('#btn_save').on('click',function(){
    			...
    			$.ajax({
                    url : "<?php echo $url ?>admin/user_create.php",
                    type : "POST",
                    dataType : "JSON",
            ...
            $('#show_data').on('click','.item_edit',function(){
                ...
                // alert(id_user);
                $.ajax({
                    url : "<?php echo $url ?>admin/user_read_by_id.php",
                    type : "POST",
                    dataType : "JSON",
            ...
            $('#btn-update').on('click', function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/user_update.php",
                    type : "POST",
                    dataType : "JSON",
            ...
            $('#show_data').on('click','.item_delete',function(){
             ...
             $('#btn_hapus').on('click',function(){
                ...
                $.ajax({
                    url : "<?php echo $url ?>admin/user_delete.php",
                    type : "POST",
                    dataType : "JSON",
                    data : {id_user: id_user},
                    success : function(data){
