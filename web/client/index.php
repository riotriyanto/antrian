...
<html lang="en">
  ...
  <body style="font-family: roboto">
    <div id="img" style="position: fixed;width: 100%">
      <img style="float: right;" src="../images/gambar_clinet.png" width="500px">
      <img style="float: right;position: fixed;margin-left: 92%;margin-top: 3%" src="../images/LOGO.png" width="50px">
    </div>
    <br>
    <div class="container" style="position: relative;">
      ...
      <div class="row" style="margin-top: 10%">
        <div class="col-md-8" style="margin-left: -20px">
          ...
          <P style="font-size: 24px">KABUPATEN KLATEN</P>
        </div>
      </div>
